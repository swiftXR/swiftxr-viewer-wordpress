    ...
    <div class="swiftxr-column">
        <div class="swiftxr-card main-card" >
            ...
            <div>
                ...
                <!-- <p>
                    <?php esc_html_e( 'Learn more about SwiftXR Viewer on Wordpress by checking out this tutorial 📚' ); ?>
                </p> -->
            </div>
        ...
        <?php }else{ ?>
            ...
            <div class="swiftxr-card swiiftxr-center">
                ...
                <img src="<?php echo htmlspecialchars('https://cdn.shopify.com/s/files/1/0262/4071/2726/files/emptystate-files.png', ENT_QUOTES); ?>" alt="Empty Image" width="250">

                <h4 class="card-title"><?php esc_html_e( 'Create interactive 3D/AR/VR views for your products', 'swiftxr-shortcodes' ); ?></h4>

                <p class="card-text"><?php esc_html_e( "Whether you're showcasing a product from every angle, providing detailed product information, or even allowing customers to try it virtually, the possibilities are endless with SwiftXR.", 'swiftxr-shortcodes' ); ?></p>

                <a href="<?php echo "https://swiftxr.io/hub"; ?>" target="_blank" rel="noopener" class="button button-primary"><?php esc_html_e( 'Publish a 3D project', 'swiftxr-shortcodes' ); ?></a>
